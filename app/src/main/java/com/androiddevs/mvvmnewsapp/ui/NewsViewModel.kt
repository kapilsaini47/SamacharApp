...
class NewsViewModel(
    ...
    fun searchNews(searchQuery:String) = viewModelScope.launch {
       handleSafeSearchNewsCalls(searchQuery)
    }
    ...
    fun getAllArticles() = newsRepository.getAllArticle()

    fun deleteArticles(article: Article) = viewModelScope.launch {
        newsRepository.deleteArticle(article)
    }

    private suspend fun handleSafeBreakingNewsCalls(countryCode: String){
    ...
    private suspend fun handleSafeSearchNewsCalls(searchQuery: String){
